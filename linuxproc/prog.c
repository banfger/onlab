...
{
    //Input megadása, elõször azt kell megadni, hogy hányszor fusson le a folyamat létrehozás/namespace beállítás, utána pedig azt, hogy mely namespace-eket szeretnénk létrehozi (fentebb szereplnek a betûjelek). Példa: pnuU
